...
def asignar_equipo(
    ...
    return AsignacionEquipoResponse(
        ...
        fecha_asignacion=db_asignacion.fecha_asignacion,
        fecha_devolucion_est=db_asignacion.fecha_devolucion_est,
        fecha_devolucion_real=db_asignacion.fecha_devolucion_real,
        notas=db_asignacion.notas,
...
def obtener_historial(
    ...
    return [
        AsignacionEquipoResponse(
            ...
            fecha_devolucion_est=a.fecha_devolucion_est,
...
def finalizar_asignacion(
    ...
    return AsignacionEquipoResponse(
        ...
        fecha_devolucion_real=asignacion.fecha_devolucion_real,
